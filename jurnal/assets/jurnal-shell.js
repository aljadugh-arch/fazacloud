(function(){
  ...
  var sets={
    admin:[['Utama','index.html','🏠','Dashboard'],['Master Data','users.html','👥','Pengguna'],['','mapel.html','📚','Mapel'],['','kelas.html','🏫','Rombel'],['','jadwal.html','📅','Jadwal'],['','pengajar.html','👨‍🏫','Pengajar'],['','wali-kelas.html','👥','Wali Kelas'],['','tahun-ajaran.html','🗓️','Tahun Ajaran'],['Absensi','absensi-siswa.html','✅','Absensi Siswa'],['','ceklok.html','📍','Ceklok Guru'],['','rekap-absensi.html','📊','Rekap'],['','absensi-ekskul.html','⚽','Ekskul'],['','absensi-jamaah.html','🕌','Jamaah'],['','absensi-kegiatan.html','🎯','Kegiatan'],['Akademik','jurnal.html','📓','Jurnal Mengajar'],['','penilaian.html','📝','Penilaian'],['','rapor.html','📄','Rapor'],['','beasiswa.html','🎓','Beasiswa'],['','modul-ajar.html','📘','Modul Ajar'],['','catatan-kepribadian.html','🧠','Catatan'],['','supervisi.html','✅','Supervisi'],['Keuangan','keuangan.html','💰','Tagihan & Tabungan'],['','cashless.html','🛒','Cashless'],['Lainnya','posting.html','📢','Posting'],['','broadcast.html','✉️','Broadcast WA'],['','settings.html','⚙️','Pengaturan'],['','backup.html','💾','Backup']],
    guru:[['Utama','index.html','🏠','Dashboard'],['Akademik','jadwal.html','📅','Jadwal Saya'],['','jurnal.html','📓','Jurnal Mengajar'],['','penilaian.html','📝','Penilaian Harian'],['','modul-ajar.html','📘','Modul Ajar'],['','catatan.html','🧠','Catatan'],['Absensi','absensi.html','✅','Absensi Siswa'],['','absensi-ekskul.html','⚽','Absensi Ekskul'],['','ceklok.html','📍','Ceklok Saya']],
    siswa:[['Utama','index.html','🏠','Dashboard'],['Siswa','jadwal.html','📅','Jadwal'],['','absensi.html','✅','Absensi Saya'],['','nilai.html','📝','Nilai'],['','ekskul.html','⚽','Ekskul']],
